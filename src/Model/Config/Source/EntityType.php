...
class EntityType
    extends Eav
{
    /** @var \Tofex\Core\Helper\EntityType */
    protected $entityTypeHelper;

    /**
     * @param \Tofex\Core\Helper\EntityType $entityTypeHelper
     */
    public function __construct(\Tofex\Core\Helper\EntityType $entityTypeHelper)
    {
